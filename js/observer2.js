...
class User {
    ...
    getNews(data) {
        ...
        title.appendChild(document.createTextNode(`${hh}:${mm}:${ss}`));
...
class Create {
    ...
    addItem (ul) {
        ...
        // console.log(this.person.getNews);
...
let user1 = new Create(Dima);
let user2 = new Create(Andy);
let user3 = new Create(Joe);

let list1 = document.querySelector('.flex-container');
...
const textField = document.querySelector('#textNews'),
